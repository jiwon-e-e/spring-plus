...
public class TodoController {
    ...
    public ResponseEntity<Page<TodoResponse>> getTodos(
            ...
            @RequestParam(required = false) LocalDateTime startModified,
            @RequestParam(required = false) LocalDateTime endModified
    ) {
        return ResponseEntity.ok(todoService.getTodos(page, size, weather, startModified, endModified));
    }
